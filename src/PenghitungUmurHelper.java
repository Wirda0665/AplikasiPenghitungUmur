...
public class PenghitungUmurHelper {
    ...
    public void getPeristiwaBarisPerBaris(LocalDate tanggal, JTextArea txtAreaPeristiwa, Supplier<Boolean> shouldStop) throws MalformedURLException, IOException, Exception {
            try {
